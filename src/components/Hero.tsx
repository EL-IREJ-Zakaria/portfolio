  ...
  return (
    <div className="relative w-full max-w-sm mx-auto aspect-square">
      ...
      <div className="absolute inset-8 rounded-3xl glass-card flex flex-col items-center justify-center gap-4 shadow-2xl shadow-primary/10">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-xl shadow-primary/30">
          <span className="text-3xl font-bold text-white font-mono">Z</span>
        </div>
